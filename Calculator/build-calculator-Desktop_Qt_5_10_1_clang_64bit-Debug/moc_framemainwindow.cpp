/****************************************************************************
** Meta object code from reading C++ file 'framemainwindow.h'
**
...
#include "../calculator/framemainwindow.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'framemainwindow.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 10, 17), // "signal_Frame_open"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 14) // "OpenCalculator"

    },
    "MainFrame\0signal_Frame_open\0\0"
    "OpenCalculator"
};
...
void MainFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_Frame_open(); break;
        case 1: _t->OpenCalculator(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainFrame::signal_Frame_open)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MainFrame::signal_Frame_open()
{
